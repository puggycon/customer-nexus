...
export function SettingsIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M19.4 13a7.97 7.97 0 0 0 0-2l2-1.6-2-3.4-2.4.7a8 8 0 0 0-1.7-1l-.4-2.5h-4l-.4 2.5a8 8 0 0 0-1.7 1l-2.4-.7-2 3.4 2 1.6a7.97 7.97 0 0 0 0 2l-2 1.6 2 3.4 2.4-.7a8 8 0 0 0 1.7 1l.4 2.5h4l.4-2.5a8 8 0 0 0 1.7-1l2.4.7 2-3.4-2-1.6Z"
        strokeLinecap="round"
